...
public class VolcanoPlugin implements IBlocksPlugin {
    ...
    private void fillGrid(BlockSparseMatrix grid, VolcanoParameters params, IPluginCallback cb) {
    ...
    private void fillColumn(int x, int y, BlockSparseMatrix grid, VolcanoParameters params) {
