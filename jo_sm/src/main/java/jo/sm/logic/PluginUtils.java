...
public class PluginUtils {
    ...
    public static void getEffectiveSelection(StarMade sm, BlockSparseMatrix grid, Point3i lower, Point3i upper) {
    ...
    public static Iterator<Point3i> getEffectiveSelectionIterator(StarMade sm, BlockSparseMatrix grid) {
    ...
    public static void fill(BlockSparseMatrix grid, int x1, int y1, int z1,
            int x2, int y2, int z2, int blockID, int orientation) {
        fill(grid, new Point3i(x1, y1, z1), new Point3i(x2, y2, z2), blockID, orientation);
    }

    public static void fill(BlockSparseMatrix grid, Point3i lower,
